...
Like many of us, I'd seen the cool little badges that better R programmers had on the repositories, saying things like "code coverage: 80%".  These badges are normally reporting something from another site, in this case, the unit testing results for your package and how much of the code within you pacage they cover.
