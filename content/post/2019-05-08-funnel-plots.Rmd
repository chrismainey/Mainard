...
funnel_plot(numerator=medpar$los, denominator=medpar$prds, group = medpar$provnum, title = 'Length of Stay Funnel plot for `medpar` data', 
            Poisson_limits = TRUE, OD_adjust = FALSE, label_outliers = TRUE, limit=99)
...
funnel_plot(numerator=medpar$los, denominator=medpar$prds, group = medpar$provnum,  title = 'Length of Stay Funnel plot for `medpar` data', Poisson_limits = FALSE, OD_adjust = TRUE, label_outliers = TRUE, limit=99)
...
If you'd like to use my outline `ggplot2` function, or contribute, please pull or fork it on github: https://github.com/chrismainey/FunnelPlotR, or install from CRAN with `install.packages("FunnelPlotR")`.
